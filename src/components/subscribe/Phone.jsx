...
const PhoneNumber = () => {
  return (
    <button className="flex items-center justify-center gap-5 bg-green-600 w-full text-white py-2 lg:py-4 px-16 rounded-2xl transition-all duration-400 transform hover:scale-105">
